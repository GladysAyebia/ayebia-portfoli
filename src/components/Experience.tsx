...
const experiences = [
  ...
  },
  {
    ...
    type: "Freelance",
    icon: <FiBriefcase />,
    desc: "Providing full-stack development services for clients, building responsive, dynamic web and mobile applications. Specialising in React, JavaScript, and modern frontend frameworks, along with backend integrations using Node.js and Express.",
  ...
  },
  {
    ...
    tags: ["Community", "Social Media", "Web Design"],
    color: "#F43F5E",
  },
  {
